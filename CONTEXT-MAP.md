...
- [Conversations](./docs/domain/conversations/CONTEXT.md) — owns channels, direct spaces, named topics, contributions, and resolutions
...
- **Identity and Access → Conversations**: supplies the workspace identity that authors contributions and determines which conversation containers it may access.
- **Conversations → Attention**: topic and contribution activity can be followed, deliberately delivered to an inbox, or attached to a response request.
...
- **Integrations → Conversations**: plugins may contribute actions and structured contributions inside an accessible topic.
