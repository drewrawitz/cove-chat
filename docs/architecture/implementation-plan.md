...
- Decode all untrusted boundaries with Effect Schema.
...
- Do not add TanStack Query initially. Add it only if substantial one-shot HTTP query workflows emerge that Zero should not synchronize.
